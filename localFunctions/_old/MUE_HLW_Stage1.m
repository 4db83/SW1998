...
function [Lambdas,Stats] = MUE_HLW_Stage1(xfilt)
...
for ii = 1:4
	...
	if(isempty(IL)) % if this creates problems, see how Stage has this call
		Lambda_hat(ii,1) = 0;
	else
		% now interpolate and divide by T
