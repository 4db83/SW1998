...
function [Lambdas, Stats] = MUE_HLW_Stage2_baseline(Yin, Xin)
...
for tt = 4:(T-4) % note it is 4:(T-4) as i in 4:(T-5) means that in R
 	ols_out	= fullols(Yin,[Xin Tvec > tt],1); % the 1 is included to not add a second intercept as Xin already includes a vector of ones in the last column
